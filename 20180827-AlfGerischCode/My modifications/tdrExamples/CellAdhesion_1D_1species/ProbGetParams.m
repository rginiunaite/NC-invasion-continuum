...
tdr.tvec   = [0:1:50 60:100]; % initial time and output times.
...
params.c_Sc1c1 = 1;  % cell-cell adhesion coefficient (aggregation)
%params.c_Sc1c1 = 0.1;  % cell-cell adhesion coefficient (no aggregation)
